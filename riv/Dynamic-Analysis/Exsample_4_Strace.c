...
/*
strace -> システムコールのトレースに使用する。システムコールはカーネルが提供する関数群で、ファイルの操作、メモリの割り当て、プロセスの制御などを行う際に使用される
...
mmap(NULL, 40058, PROT_READ, MAP_PRIVATE, 3, 0) = 0x7fb45aac9000
close(3)                                = 0
...
clone(child_stack=NULL, flags=CLONE_CHILD_CLEARTID|CLONE_CHILD_SETTID|SIGCHLD, child_tidptr=0x7fb45aac8810) = [REDACTED]
Segmentation Fault
fstat(1, {st_mode=S_IFCHR|0620, st_rdev=makedev(0x88, 0), ...}) = 0
brk(NULL)                               = 0x55eea8d7e000
brk(0x55eea8d9f000)                     = 0x55eea8d9f000
write(1, "Enter the pid of the child proce"..., 35) = 35
fstat(0, {st_mode=S_IFCHR|0620, st_rdev=makedev(0x88, 0), ...}) = 0
read(0, "[REDACTED]", 1024) = 5
write(1, "Correct! your Flag is [REDACTED]"..., 35) = 35
exit_group(0)                           = ? 
+++ exited with 0 +++
